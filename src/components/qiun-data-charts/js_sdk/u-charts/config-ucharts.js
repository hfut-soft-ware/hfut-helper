...
const cfu = {
  ...
  formatter: {
    ...
    //   return val + '元'
    // },
    seriesFixed(val, index, series, opts) {
      return val.toFixed(2)
    },
    tooltipLine: function (item, category, index, opts) {
      // console.log(item)
      // console.log(category)
      // console.log(opts)
      // console.log(index)
      const semesters = ['一', '二', '三', '四', '五', '六', '七', '八', '九', '十']

      return `学期${semesters[index]} ${item.name} ${item.data}`
